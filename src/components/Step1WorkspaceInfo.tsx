    ...
    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 shadow-xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-neutral-800">
        <div>
          ...
          <p className="text-xs text-neutral-400 mt-1 pl-8">
            Queries the Power BI REST API (<code className="bg-neutral-800 border border-neutral-700 px-1 py-0.5 rounded text-amber-500 font-mono text-[11px]">GET /v1.0/myorg/pipelines/{'{pipelineId}'}/stages</code>) to discover Stage and Production workspace bindings.
          </p>
        </div>
      ...
      {pipelineData?.pipeline ? (
        <div className="mt-6 space-y-6">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-4 shadow-xl">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
              ...
              <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-neutral-950 border border-neutral-800 text-neutral-400">
                ID: {pipelineData.pipeline.id}
              </span>
            </div>
            {pipelineData.pipeline.description && (
              <p className="text-xs text-neutral-600">{pipelineData.pipeline.description}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-11 gap-4 items-center">
            ...
            <div className="md:col-span-5 border border-amber-500/30 bg-amber-900/10 rounded-xl p-4 relative">
              ...
              <div className="mt-3 pt-3 border-t border-amber-500/20 flex items-center justify-between text-xs text-neutral-400">
            ...
            <div className="md:col-span-1 flex justify-center py-2 md:py-0">
              <div className="w-9 h-9 rounded-full bg-neutral-900 border border-neutral-700 flex items-center justify-center text-neutral-400 shadow-xl">
            ...
            <div className="md:col-span-5 border border-emerald-500/30 bg-emerald-900/10 rounded-xl p-4 relative">
              ...
              <div className="mt-3 pt-3 border-t border-emerald-500/20 flex items-center justify-between text-xs text-neutral-400">
                <span className="flex items-center gap-1">
        ...
        <div className="mt-8 text-center py-10 border-2 border-dashed border-neutral-800 rounded-xl bg-neutral-900/50">
          <Server className="w-10 h-10 text-neutral-600 mx-auto mb-2" />
          <p className="text-xs font-medium text-neutral-300">Workspace topology not yet queried</p>
